...
//    ComponentPtr CloneComponent(const ComponentPtr &component, const QString &newComponentName);
    ...
    /** @note Never use this from script (the allocated IAttribute* cannot be freed)! In script use EC_DynamicComponent::CreateAttribute instead.
        @param attributeTypeName Attribute type name, handled as case-insensitive.
    ...
    static IAttribute* CreateAttribute(u32 attributeTypeId, const QString& newAttributeId); /**< @overload @param attributeTypeId Attribute type name ID. */
