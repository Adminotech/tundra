...
const QString IAttribute::VariantTypeName = "QVariant"; /**< @todo This is used when serializing attribute to XML and is Q-prefixed for transitional period; the prefix will be removed soon. */
