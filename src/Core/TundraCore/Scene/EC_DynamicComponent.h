...
public slots:
    ...
    void SetAttribute(const QString &id, const QVariant &value, AttributeChange::Type change = AttributeChange::Default); /**< @overload @param id ID of the attribute, case-insensitive. */
