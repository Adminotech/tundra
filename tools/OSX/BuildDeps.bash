...
if [ "$RUN_CMAKE" == "1" ]; then
    TUNDRA_DEP_PATH=$prefix cmake . $XCODE_SUFFIX \
        ...
        -DCMAKE_OSX_SYSROOT=$OSX_SDK_ROOT \
        -DTUNDRA_NO_BOOST:BOOL=$NO_BOOST \
        -DTUNDRA_CPP11_ENABLED:BOOL=$NO_BOOST \
        -DTUNDRA_VERSION_POSTFIX="$TUNDRA_VERSION_POSTFIX" \
        -DTUNDRA_ADDONS_INSTALL_CONFIG=OFF \
        -DTUNDRA_ADDONS_INSTALL_SCENES=OFF \
        -DTUNDRA_ADDONS_INSTALL_JSMODULES=OFF \
        -DTUNDRA_ADDONS_HTTP_SERVER_PLUGIN=OFF
fi
